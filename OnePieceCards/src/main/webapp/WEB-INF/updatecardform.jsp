...
<body>
	<h3>Enter The Card Details</h3>
		...
		<form action="updatedCard.do" method="POST">
		
		Card Number:<input type="number" name="id" value="${updateWith.id }"/> <br>
...
<input class="btn btn-primary" type="submit" value="Update Card" />
	</form>
	<br>
